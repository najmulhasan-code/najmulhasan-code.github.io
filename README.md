...
I completed a B.S. in Computer Science, with minors in Mathematics and Physics, at the University of North Carolina at Pembroke, where I worked with [Dr. Prashanth BusiReddyGari](https://www.uncp.edu/about/directory/prashanth-busi_reddy_gari.html) and [Dr. Shaohu Zhang](https://zhangshaohu.github.io/). I was an AI Safety Research Fellow at [Algoverse](https://algoverseairesearch.org). I completed the [AI Safety Fundamentals Fellowship (AISF)](https://aialignment.mit.edu/) with MIT AI Alignment (MAIA) and [BlueDot Impact's Technical AI Safety course](https://bluedot.org/courses/technical-ai-safety). I am currently participating in BlueDot Impact's [Technical AI Safety Project Sprint](https://bluedot.org/courses/technical-ai-safety-project), where I am working on language-model alignment during pretraining.
