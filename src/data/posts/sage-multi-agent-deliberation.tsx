...
export const post: Post = {
  ...
  published: true,
  thumbnail: '/blog/sage-multi-agent-deliberation/hero.png',
  links: [
    'https://github.com/najmulhasan-code/sage',
    'https://pypi.org/project/agentsage/',
  ],
  content: (
    <>
      <p>
        ...
        <img
          src="/blog/sage-multi-agent-deliberation/hero.png"
      ...
      <p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/blog/sage-multi-agent-deliberation/figure-1.png"
          alt="Research Phase"
          loading="lazy"
      ...
      <p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/blog/sage-multi-agent-deliberation/figure-2.png"
      ...
      <p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/blog/sage-multi-agent-deliberation/figure-3.png"
          alt="Synthesis Phase"
          loading="lazy"
          style={{ width: '100%', borderRadius: '8px', border: '1px solid #e5e7eb', marginBottom: '0.5rem' }}
        />
